...
import sys
import os
sys.path.append('/data/czx/MambaIR/realDenoising')
# sys.path.append('/data/czx/MambaIR')
...
def parse_options(is_train=True):
    ...
    parser.add_argument(
        '-opt', type=str, default="/data/czx/MambaIR/options/train/train_MambaIR_CC.yml", help='Path to option YAML file.')
    parser.add_argument(
        '--launcher',
    ...
    for epoch in range(start_epoch, total_epochs + 1):
        for i, train_data in enumerate(train_loader):
            ...
            if current_iter % opt['logger']['print_freq'] == 0:
                ...
                log_vars.update({'time': iter_time.get_avg_time(), 'data_time': data_timer.get_avg_time()})
